...
MEMBERS = [
    ...
    {"name": "task_graph_analyzer", "module": task_graph_analyzer, "role": "dependency_analysis"},
    ...
    {"name": "intersection_mapper", "module": intersection_mapper, "role": "integration_planning"},
]
...
def calculate_risk(tasks: list[dict[str, Any]], dependency_graph: dict[str, Any]) -> dict[str, Any]:
