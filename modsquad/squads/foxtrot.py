...
from extensions import guardrail_scheduler, stream_coordinator, runner
...
MEMBERS = [
    ...
    {"name": "stream_coordinator", "module": stream_coordinator, "role": "coordination"},
...
def pre_deploy_check():
    ...
    bravo_passed = results["squad_results"].get("bravo", {}).get("overall_passed", False)
    charlie_vulnerabilities = results["squad_results"].get("charlie", {}).get("vulnerabilities_found", 0)
