...
from extensions import security_patch_advisor, dependency_tracker

MEMBERS = [
    {"name": "security_patch_advisor", "module": security_patch_advisor, "role": "leader"},
    {"name": "dependency_tracker", "module": dependency_tracker, "role": "architecture"},
]
