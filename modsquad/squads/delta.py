...
from extensions import component_diff_reporter, docs_sync, data_latency_tracker

MEMBERS = [
    {"name": "component_diff_reporter", "module": component_diff_reporter, "role": "leader"},
    {"name": "docs_sync", "module": docs_sync, "role": "documentation"},
    {"name": "data_latency_tracker", "module": data_latency_tracker, "role": "performance"},
]
