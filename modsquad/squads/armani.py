...
MEMBERS = [
    ...
    {"name": "interface_predictor", "module": interface_predictor, "role": "interface_analysis"},
    {"name": "glue_code_generator", "module": glue_code_generator, "role": "code_generation"},
    {"name": "conflict_resolver", "module": conflict_resolver, "role": "conflict_resolution"},
    {"name": "intersection_executor", "module": intersection_executor, "role": "execution"},
    {"name": "integration_validator", "module": integration_validator, "role": "validation"},
]
...
def resolve_conflicts(
    batch_a_changes: dict[str, Any],
    batch_b_changes: dict[str, Any]
) -> dict[str, Any]:
